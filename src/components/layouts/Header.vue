...
<v-row>
    ...
    <v-col cols="2">
        <NewContactButton v-if="hasContact"/>
    </v-col>

    <v-col cols="8">
        <v-text-field class="text-field-custom" filled outlined v-model="model.search" density="compact" append-inner-icon="mdi-magnify">
...
import NewContactButton from '@/components/buttons/NewContactButton.vue'
import { contactsModel } from '@/models/contacts'

const model = contactsModel()
const hasContact = computed(() => model.contacts.length > 0)
</script>
